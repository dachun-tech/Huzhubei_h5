...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        <!-- BEGIN LOGO -->
        <div class="page-logo">
            <a href="<?=base_url('/admin')?>" style="height:100%;text-align:center;">
                <img src="<?= base_url('assets/images/backend-logo.png') ?>" alt="logo" class="logo-default" style="height:100%;width:auto;display:inline-block;"> </a>
