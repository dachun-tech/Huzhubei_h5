                            ...
                            <div class="col-md-7">
                                <div class="btn-group right-floated">
                                    <button class=" btn blue" id="add_new_admin_btn"><i
                                                class="fa fa-plus"></i>&nbsp<?php echo $this->lang->line('add_administrator'); ?>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="main_tbl">
                            ...
                            <tr>
                                ...
                                <th><?php echo $this->lang->line('admin_account'); ?></th>
                                <th><?php echo $this->lang->line('admin_label'); ?></th>
                                <th><?php echo $this->lang->line('usage_status'); ?></th>
                                <th width="300px;"><?php echo $this->lang->line('edit'); ?></th>
                            </tr>
                            </thead>
...
<div id="add_admin_modal" class="modal fade" tabindex="-1" data-width="400">
    <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo $this->lang->line('add_administrator'); ?></h4>
    </div>
        ...
        <form class="form-horizontal" enctype="multipart/form-data" action="" id="add_admin_submit_form" role="form"
            ...
            <div class="modal-footer form-actions">
                <button type="submit" class="btn green"
                        id="add_admin_saveBtn"><?php echo $this->lang->line('next_step'); ?></button>
            </div>
        </form>
    </div>
</div>
...
<div id="edit_admin_modal" class="modal fade" tabindex="-1" data-width="400">
    ...
    <div class="modal-body">
        <form class="form-horizontal" enctype="multipart/form-data" action="" id="edit_admin_submit_form" role="form"
            ...
            <div class="modal-footer form-actions">
                <button type="submit" class="btn green"
                        id="edit_admin_saveBtn"><?php echo $this->lang->line('save'); ?></button>
                <button type="button" class="btn green"
