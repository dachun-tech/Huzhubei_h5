...
class SendTemplateSMS
{
    ...
    public static function getAcsClient()
    {
        ...
        $accessKeyId = "LTAIf5g6RCSax0yk"; // AccessKeyId

        $accessKeySecret = "IntStSisMnqXDya9VFIzaqh4RVI1H9"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone, $sms_code)
    {
        ...
        $request->setSignName("股励");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_122291923");
...
$response = SendTemplateSMS::sendSms($phoneNumber, $verify);
if ($response->Code == 'OK') {
    echo json_encode(array('result' => 'success', 'code' => $verify));
} else {
    echo json_encode(array('result' => 'fail', 'code' => $response->Message));
}
...
//sleep(2);
//
//$response = SendSMS::sendBatchSms();
//echo "批量发送短信(sendBatchSms)接口返回的结果:\n";
//print_r($response);
//
//sleep(2);
//
//$response = SendSMS::querySendDetails();
